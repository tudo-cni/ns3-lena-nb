...
#ifndef APPLICATION_5G_CLIENT_H
#define APPLICATION_5G_CLIENT_H
 ...
 * \brief A Application 5G client
 *
 * Every packet sent should be returned by the server and received here.
 */
class Application5GClient : public Application 
{
public:
