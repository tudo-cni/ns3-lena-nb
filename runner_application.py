...
for i in range(1,seed+1):
    ...
    simu_queue.add_task(SimulationParameters(simTime=simTime,simulation=sim_command, randomSeed=i, num_ues_app_a=1, num_ues_app_b=0, num_ues_app_c=0, ciot=False, edt=False, pur=False))
