...
def build(bld):
    ...
    module.source = [
        ...
        'helper/application-5g-client.cc',
        'helper/application-5g-helper.cc',
        'helper/application-5g-server.cc',
    ...
    headers.source = [
        ...
        'helper/application-5g-client.h',
        'helper/application-5g-helper.h',
        'helper/application-5g-server.h',
