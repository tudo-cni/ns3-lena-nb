...
template <class C>
void MemberLteCcmMacSapUser<C>::NotifyTxOpportunityNb (LteMacSapUser::TxOpportunityParameters txOpParams, uint32_t schedulingDelay)
{
  m_owner->DoNotifyTxOpportunityNb (txOpParams, schedulingDelay);
}
