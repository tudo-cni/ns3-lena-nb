...
private:
  ...
  std::map<uint8_t, std::map<uint8_t, uint16_t>> TransportBlockSizeTableDlNb{
    ...
    /*TBSI 9*/  {9,  {{1, 136}, {2, 296}, {3, 456}, {4, 616}, {5, 0},   {6, 0},   {8, 0},   {10, 0}}},
    /*TBSI 10*/ {10, {{1, 144}, {2, 328}, {3, 504}, {4, 680},   {5, 0},   {6, 0},   {8, 0},   {10, 0}}},
  ...
  std::map<uint8_t, std::map<uint8_t, uint16_t>> TransportBlockSizeTableUlNb{
    ...
    /*TBSI 7*/  {7,  {{1, 104}, {2, 224}, {3, 328}, {4,  472}, {5,  584}, {6,  712}, {8, 1000}, {10,    0}}},
    /*TBSI 8*/  {8,  {{1, 120}, {2, 256}, {3, 392}, {4,  536}, {5,  680}, {6,  808}, {8,    0}, {10,    0}}},
    /*TBSI 9*/  {9,  {{1, 136}, {2, 296}, {3, 456}, {4,  616}, {5,  776}, {6,  936}, {8,    0}, {10,    0}}},
    /*TBSI 10*/ {10, {{1, 144}, {2, 328}, {3, 504}, {4,  680}, {5,  872}, {6, 1000}, {8,    0}, {10,    0}}},
    /*TBSI 11*/ {11, {{1, 176}, {2, 376}, {3, 584}, {4,  776}, {5, 1000}, {6,    0}, {8,    0}, {10,    0}}},
    /*TBSI 12*/ {12, {{1, 208}, {2, 440}, {3, 680}, {4, 1000}, {5,    0}, {6,    0}, {8,    0}, {10,    0}}}
